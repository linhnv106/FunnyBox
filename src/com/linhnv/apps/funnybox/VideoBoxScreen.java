...
import com.linhnv.apps.funnybox.fragment.TopFunVideoFragment;
import com.linhnv.apps.funnybox.fragment.TopHotFragment;
import com.linhnv.apps.funnybox.fragment.TopVideoFragment;
import com.linhnv.apps.funnybox.utils.ImageFetcher;
import com.linhnv.apps.funnybox.utils.ImageCache.ImageCacheParams;
public class VideoBoxScreen extends SherlockFragmentActivity{
...
//        mImageWorker.setAdapter(Images.imageWorkerUrlsAdapter);
		...
		mTabsAdapter.addTab(mTabHost.newTabSpec("Hot Video").setIndicator("TOP HOT"), TopVideoFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("fun").setIndicator("FUN "), TopFunVideoFragment.class, null);
		mTabsAdapter.addTab(mTabHost.newTabSpec("aldult").setIndicator("18+"), TopFunVideoFragment.class, null);
		if(arg0!=null){
